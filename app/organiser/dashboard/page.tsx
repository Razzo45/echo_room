              ...
              >
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="min-w-0 flex-1">
                    ...
                    {event.description && (
                      <p className="text-sm text-gray-600 mt-0.5 line-clamp-2">{event.description}</p>
                    )}
                  </div>
                  <span
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <span className="text-xs font-semibold text-primary-600">{event.eventCodes.length} codes</span>
                </div>
              </Link>
            ))}
          </div>
