...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-admin-bg">
      <div className="hero-event rounded-b-[2rem] bg-gradient-to-b from-zinc-800 to-admin-bg">
        <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-4">
          <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
        </div>
        <h1 className="text-3xl font-bold text-white tracking-tight mb-1 font-display">Admin Access</h1>
      ...
      <div className="flex-1 px-4 -mt-6 relative z-10 max-w-md mx-auto w-full pb-8 safe-bottom">
        <div className="rounded-3xl p-6 border border-admin-border bg-admin-surface shadow-soft">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                autoFocus
              />
              <p className="text-xs text-zinc-400 mt-1">Leave empty to use admin password only.</p>
            </div>
            <div>
